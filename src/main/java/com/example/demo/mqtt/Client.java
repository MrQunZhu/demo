...
public class Client {
	private final static String CONNECTION_STRING = "tcp://182.92.180.112:61613";
    private final static boolean CLEAN_START = true;    
    private final static short KEEP_ALIVE = 30;// 低耗网络，但是又需要及时获取数据，心跳30s    
    private final static String CLIENT_ID = "test1";    
    public static Topic[] topics = {     
//        new Topic("mqtt/aaa", QoS.EXACTLY_ONCE), //  2 只有一次  
//        new Topic("mqtt/bbb", QoS.AT_LEAST_ONCE),  // 1 至少一次  
        new Topic("hello", QoS.AT_MOST_ONCE) };  // 0 至多一次
